...
PriceBasic.create!(tour: Tour.first, customers_type: "Người lớn", price_default: "2090000", position: "1")
PriceBasic.create!(tour: Tour.first, customers_type: "Trẻ em",    price_default: "1492500", position: "2")
PriceBasic.create!(tour: Tour.first, customers_type: "Trẻ nhỏ",   price_default: "1000000", position: "3")
PriceBasic.create!(tour: Tour.first, customers_type: "Em bé",     price_default: "220000", position: "4")
PriceBasic.create!(tour: Tour.first, customers_type: "Phụ thu phòng đơn", price_default: "600000", position: "5")
#
