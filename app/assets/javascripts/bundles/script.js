if (function(n, t) {
        ...
        function iu(n, t, r) {
            ...
            if (0 >= u || null == u) {
                if (u = rt(n, t, e), (0 > u || null == u) && (u = n.style[t]), ci.test(u)) return u;
        ...
        function fe(n, t, u) {
            ...
            if (i.isEmptyObject(y)) "inline" === ("none" === h ? hi(n.nodeName) : h) && (s.display = h);
            else {
        ...
        tr = i.fn.init = function(n, t) {
            ...
            if (!n) return this;
            if ("string" == typeof n) {
                if (r = "<" === n[0] && ">" === n[n.length - 1] && n.length >= 3 ? [null, n, null] : nr.exec(n), !r || !r[1] && t) return !t || t.jquery ? (t || st).find(n) : this.constructor(t).find(n);
                if (r[1]) {
        ...
        i.fn.extend({
            on: function(n, t, r, u, f) {
                ...
                if (null == r && null == u ? (u = t, r = t = void 0) : null == u && ("string" == typeof t ? (u = r, r = void 0) : (u = r, r = t, t = void 0)), u === !1) u = g;
        ...
        i.fn.extend({
            ...
            toggleClass: function(n, t) {
                ...
                return "boolean" == typeof t && "string" === u ? t ? this.addClass(n) : this.removeClass(n) : this.each(i.isFunction(n) ? function(r) {
                    ...
                    else(u === d || "boolean" === u) && (this.className && r.set(this, "__className__", this.className), this.className = this.className || n === !1 ? "" : r.get(this, "__className__") || "")
                })
            },
            hasClass: function(n) {
                for (var i = " " + n + " ", t = 0, r = this.length; r > t; t++)
                    if (1 === this[t].nodeType && (" " + this[t].className + " ").replace(kt, " ").indexOf(i) >= 0) return !0;
                return !1
            }
        });
        cu = /\r/g;
        ...
        n[i] && n[i].version > e || (n[i] = function(n, t) {
        ...
        }, n[i].version = e, n[i].uniqueId = 0, n[i].defaults = {
            ellipsis: "… ",
            truncate: "word",
            tolerance: 0,
            keep: null,
            ...
            truncate: function() {
                ...
                return this.$inner = this.$dot.wrapInner("<div />").children().css({
                    ...
                    padding: 0,
                    margin: 0
                }), this.$inner.contents().detach().end().append(this.originalContent.clone(!0)), this.$inner.find("script, style").addClass(t.keep), this.opts.keep && this.$inner.find(this.opts.keep).addClass(t.keep), this.$inner.find("*").not("." + t.keep).add(this.$inner).contents().each(function() {
                    var u = this,
                        i = n(this),
                        f;
                    if (u.nodeType == 3) {
                    ...
                    } else u.nodeType == 8 && i.remove()
                }), i = this._truncateNode(this.$dot), this.$dot[i ? "addClass" : "removeClass"](t.truncated), this.$inner.find("." + t.text).each(function() {
                    n(this).replaceWith(n(this).contents())
                }), this.$inner.find("." + t.keep).removeClass(t.keep), this.$inner.replaceWith(this.$inner.contents()), this.$inner = null, i
            },
            restore: function() {
                this.unwatch();
            ...
            watch: function() {
                var n = this,
                    t;
                if (this.unwatch(), t = {}, this.opts.watch == "window") f.on(r.resize + n.uniqueId, function() {
            ...
            _truncateNode: function(i) {
                ...
                return n(i.children().get().reverse()).not("." + t.keep).each(function() {
                    var o = n(this).contents()[0],
                        i = n(this),
                        e;
                    if (!u && !i.hasClass(t.keep)) {
                        if (i.children().length) u = r._truncateNode(i);
                        else if (!r._fits() || f)
                            if (e = n("<span>").css("display", "none"), i.replaceWith(e), i.detach(), r._fits()) {
                                if (r.opts.truncate == "node") return !0;
                                e.replaceWith(i);
                                u = r._truncateWord(i);
                                u || (f = !0, i.detach())
                            } else e.remove();
            ...
            _truncateWord: function(n) {
                ...
                for (r = f.length; r >= 0; r--) {
                    if (e = f.slice(0, r).join(u), r == 0) return t.opts.truncate == "letter" ? (t.__setTextContent(i, f.slice(0, r + 1).join(u)), t._truncateLetter(i)) : !1;
                    if (e.length && (t.__setTextContent(i, t._addEllipsis(e)), t._fits())) return t.opts.truncate == "letter" ? (t.__setTextContent(i, f.slice(0, r + 1).join(u)), t._truncateLetter(i)) : !0
                }
                return !1
            },
            _truncateLetter: function(n) {
                for (var i = this, f = this.__getTextContent(n), u = f.split(""), r = "", t = u.length; t >= 0; t--)
                    if ((r = u.slice(0, t).join(""), r.length) && (i.__setTextContent(n, i._addEllipsis(r)), i._fits())) return !0;
                return !1
            },
            _fits: function() {
            ...
            _getMaxHeight: function() {
                for (var t = ["height", "maxHeight"], r = 0, i, u, n = 0; n < t.length; n++) i = window.getComputedStyle(this.$dot[0])[t[n]], i.slice(-2) == "px" && (i = parseFloat(i), r = r ? Math.min(r, i) : i);
                switch (this.$dot.css("boxSizing")) {
                    case "padding-box":
                    case "border-box":
                        for (t = ["paddingTop", "paddingBottom"], n = 0; n < t.length; n++) u = window.getComputedStyle(this.$dot[0])[t[n]], u.slice(-2) == "px" && (r -= parseFloat(u))
                }
                return Math.max(r, 0)
            },
            ...
            return o(), t = n.extend(!0, {}, n[i].defaults, t), this.each(function() {
        ...
        function t(i, r, u, f, e) {
            r <= u ? (n(".roller-title-number-" + i).html(r), r = parseInt(r) + parseInt(f), setTimeout(function() {
        ...
        n.fn.scrollzip = function(t) {
            ...
            return this.each(function() {
                return n(this).addClass("scrollzip"), n.isFunction(i.showFunction) && !n(this).hasClass("isShown") && n(window).outerHeight() + n("#scrollzipPoint").offset().top - i.showShift > n(this).offset().top + (i.wholeVisible ? n(this).outerHeight() : 0) && n("#scrollzipPoint").offset().top + (i.wholeVisible ? n(this).outerHeight() : 0) < n(this).outerHeight() + n(this).offset().top - i.showShift && (n(this).addClass("isShown"), i.showFunction.call(this)), n.isFunction(i.hideFunction) && n(this).hasClass("isShown") && (n(window).outerHeight() + n("#scrollzipPoint").offset().top - i.hideShift < n(this).offset().top + (i.wholeVisible ? n(this).outerHeight() : 0) || n("#scrollzipPoint").offset().top + (i.wholeVisible ? n(this).outerHeight() : 0) > n(this).outerHeight() + n(this).offset().top - i.hideShift) && (n(this).removeClass("isShown"), i.hideFunction.call(this)), this
            })
        }
    }(jQuery), function() {
...
function(n) {
    n.fn.shorten = function(t) {
        ...
        n(document).on({
            click: function() {
                var t = n(this);
                return t.hasClass("less") ? (t.removeClass("less"), t.html(i.moreText)) : (t.addClass("less"), t.html(i.lessText)), t.parent().prev().toggle(), t.prev().slideToggle(), !1
            }
        }, ".morelink");
        return this.each(function() {
            var r = n(this),
                t;
            if (!r.hasClass("shortened") && (r.addClass("shortened"), t = r.html(), t.length > i.showChars)) {
...
! function(n, t) {
    ...
    f.prototype = {
        ...
        _process_options: function(f) {
            ...
            if (o.startView = Math.max(o.startView, o.minViewMode), o.multidate !== !0 && (o.multidate = Number(o.multidate) || !1, o.multidate !== !1 && (o.multidate = Math.max(0, o.multidate))), o.multidateSeparator = String(o.multidateSeparator), o.weekStart %= 7, o.weekEnd = (o.weekStart + 6) % 7, a = i.parseFormat(o.format), (o.startDate !== -(1 / 0) && (o.startDate = o.startDate ? o.startDate instanceof Date ? this._local_to_utc(this._zero_time(o.startDate)) : i.parseDate(o.startDate, a, o.language) : -(1 / 0)), o.endDate !== 1 / 0 && (o.endDate = o.endDate ? o.endDate instanceof Date ? this._local_to_utc(this._zero_time(o.endDate)) : i.parseDate(o.endDate, a, o.language) : 1 / 0), o.daysOfWeekDisabled = o.daysOfWeekDisabled || [], n.isArray(o.daysOfWeekDisabled) || (o.daysOfWeekDisabled = o.daysOfWeekDisabled.split(/[,\s]*/)), o.daysOfWeekDisabled = n.map(o.daysOfWeekDisabled, function(n) {
        ...
        fill: function() {
            var y, g = new Date(this.viewDate),
                ...
                b = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0,
                et = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0,
...
function(n) {
    "function" == typeof define && define.amd ? define(["jquery"], function(t) {
        ...
        return t || (t = window), i || (i = "undefined" != typeof window ? require("jquery") : require("jquery")(t)), n(i, t, t.document)
    } : n(jQuery, window, document)
}(function(n, t, i, r) {
    function at(t) {
        var i, r, u = {};
        n.each(t, function(n) {
            (i = n.match(/^([^A-Z]+?)([A-Z])/)) && -1 !== "a aa ai ao as b fn i m o s ".indexOf(i[1] + " ") && (r = n.replace(i[0], i[2].toLowerCase()), u[r] = n, "o" === i[1] && at(t[n]))
        });
        t._hungarianMap = u
    }
    ...
    function nt(t, i, u) {
        ...
        n.each(i, function(e) {
            f = t._hungarianMap[e];
            f !== r && (u || i[f] === r) && ("o" === f.charAt(0) ? (i[f] || (i[f] = {}), n.extend(!0, i[f], i[e]), nt(t[f], i[f], u)) : i[f] = i[e])
        })
    }
    ...
    function lu(n) {
        if (p(n, "ordering", "bSort"), p(n, "orderMulti", "bSortMulti"), p(n, "orderClasses", "bSortClasses"), p(n, "orderCellsTop", "bSortCellsTop"), p(n, "order", "aaSorting"), p(n, "orderFixed", "aaSortingFixed"), p(n, "paging", "bPaginate"), p(n, "pagingType", "sPaginationType"), p(n, "pageLength", "iDisplayLength"), p(n, "searching", "bFilter"), "boolean" == typeof n.sScrollX && (n.sScrollX = n.sScrollX ? "100%" : ""), "boolean" == typeof n.scrollX && (n.scrollX = n.scrollX ? "100%" : ""), n = n.aoSearchCols)
            for (var t = 0, i = n.length; t < i; t++) n[t] && nt(u.models.oSearch, n[t])
    }
    ...
    function yu(n, t, i, u, f, e) {
        var o, s = !1;
        for (i !== r && (o = i, s = !0); u !== f;) n.hasOwnProperty(u) && (o = s ? t(o, n[u], u, n) : n[u], s = !0, u += e);
        return o
    }
    ...
    function ei(t, i, f) {
        var i = t.aoColumns[i],
            ...
            s = n(i.nTh),
            h;
        i.sWidthOrig || (i.sWidthOrig = s.attr("width") || null, h = (s.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/), h && (i.sWidthOrig = h[1]));
        f !== r && null !== f && (au(f), nt(u.defaults.column, f), f.mDataProp !== r && !f.mData && (f.mData = f.mDataProp), f.sType && (i._sManualType = f.sType), f.className && !f.sClass && (f.sClass = f.className), n.extend(i, f), k(i, f, "sWidth", "sWidthOrig"), f.iDataSort !== r && (i.aDataSort = [f.iDataSort]), k(i, f, "aDataSort"));
        var o = i.mData,
            l = ft(o),
        ...
        t.oFeatures.bSort || (i.bSortable = !1, s.addClass(e.sSortableNone));
        t = -1 !== n.inArray("asc", i.asSorting);
        f = -1 !== n.inArray("desc", i.asSorting);
        !i.bSortable || !t && !f ? (i.sSortingClass = e.sSortableNone, i.sSortingClassJUI = "") : t && !f ? (i.sSortingClass = e.sSortableAsc, i.sSortingClassJUI = e.sSortJUIAscAllowed) : !t && f ? (i.sSortingClass = e.sSortableDesc, i.sSortingClassJUI = e.sSortJUIDescAllowed) : (i.sSortingClass = e.sSortable, i.sSortingClassJUI = e.sSortJUI)
    }

    function st(n) {
        var t, i, r;
        if (!1 !== n.oFeatures.bAutoWidth)
            for (t = n.aoColumns, wr(n), i = 0, r = t.length; i < r; i++) t[i].nTh.style.width = t[i].sWidth;
        t = n.oScroll;
        ("" !== t.sY || "" !== t.sX) && ti(n);
    ...
    function or(n) {
        for (var c = n.aoColumns, p = n.aoData, h = u.ext.type.detect, e, a, i, v, t, o, s, f = 0, l = c.length; f < l; f++)
            ...
            for (e = 0, a = h.length; e < a; e++) {
                for (i = 0, v = p.length; i < v; i++) {
                    if (s[i] === r && (s[i] = y(n, i, f, "type")), o = h[e](s[i], n), !o && e !== h.length - 1) break;
                    if ("html" === o) break
                }
                if (o) {
                    t.sType = o;
    ...
    function pu(t, i, u, f) {
        var s, o, a, c, v, h, l = t.aoColumns,
            e;
        if (i)
            for (s = i.length - 1; 0 <= s; s--)
                for (h = i[s], e = h.targets !== r ? h.targets : h.aTargets, n.isArray(e) || (e = [e]), o = 0, a = e.length; o < a; o++)
                    if ("number" == typeof e[o] && 0 <= e[o]) {
                        for (; l.length <= e[o];) er(t);
                        f(e[o], h)
                    } else if ("number" == typeof e[o] && 0 > e[o]) f(l.length + e[o], h);
        else if ("string" == typeof e[o])
            for (c = 0, v = l.length; c < v; c++)("_all" == e[o] || n(l[c].nTh).hasClass(e[o])) && f(c, h);
        if (u)
            for (s = 0, t = u.length; s < t; s++) f(s, u[s])
    }
    ...
    function rt(t, i, f, e) {
        ...
        s._aData = i;
        t.aoData.push(s);
        for (var c = t.aoColumns, h = 0, l = c.length; h < l; h++) c[h].sType = null;
        return t.aiDisplayMaster.push(o), i = t.rowIdFn(i), i !== r && (t.aIds[i] = s), (f || !t.oFeatures.bDeferRender) && lr(t, o, f, e), o
    }

    function oi(t, i) {
        var r;
        return i instanceof n || (i = n(i)), i.map(function(n, i) {
            return r = cr(t, i), rt(t, r.data, i, r.cells)
        })
    }
    ...
    function y(n, t, i, u) {
        ...
        if (f === r) return n.iDrawError != h && null === o && (tt(n, 0, "Requested unknown parameter " + ("function" == typeof e.mData ? "{function}" : "'" + e.mData + "'") + " for row " + t + ", column " + i, 4), n.iDrawError = h), o;
        if ((f === s || null === f) && null !== o) f = o;
        else if ("function" == typeof f) return f.call(s);
    ...
    function ft(t) {
        ...
        return n.isPlainObject(t) ? (i = {}, n.each(t, function(n, t) {
            ...
            var s, o, e, h;
            if ("" !== f)
                for (o = sr(f), e = 0, h = o.length; e < h; e++) {
                    if (f = o[e].match(ri), s = o[e].match(lt), f) {
                        if (o[e] = o[e].replace(ri, ""), "" !== o[e] && (t = t[o[e]]), s = [], o.splice(0, e + 1), o = o.join("."), n.isArray(t))
                            for (e = 0, h = t.length; e < h; e++) s.push(u(t[e], i, o));
    ...
    function et(t) {
        ...
        if ("function" == typeof t) return function(n, i, r) {
            t(n, "set", i, r)
        };
        if ("string" == typeof t && (-1 !== t.indexOf(".") || -1 !== t.indexOf("[") || -1 !== t.indexOf("("))) {
            var i = function(t, u, f) {
                var f = sr(f),
                    o, h, s, e, c;
                for (o = f[f.length - 1], e = 0, c = f.length - 1; e < c; e++) {
                    if (h = f[e].match(ri), s = f[e].match(lt), h) {
                        if (f[e] = f[e].replace(ri, ""), t[f[e]] = [], o = f.slice(), o.splice(0, e + 1), h = o.join("."), n.isArray(u))
                            for (s = 0, c = u.length; s < c; s++) o = {}, i(o, u[s], h), t[f[e]].push(o);
                        else t[f[e]] = u;
                        return
                    }
                    s && (f[e] = f[e].replace(lt, ""), t = t[f[e]](u));
    ...
    function hi(n, t, i) {
        for (var f = -1, u = 0, e = n.length; u < e; u++) n[u] == t ? f = u : n[u] > t && n[u]--; - 1 != f && i === r && n.splice(f, 1)
    }
        ...
        if ("dom" !== i && (i && "auto" !== i || "dom" !== f.src)) {
            if (o = f.anCells, o)
                if (u !== r) e(o[u], u);
                    ...
                    for (i = 0, s = o.length; i < s; i++) e(o[i], i)
        } else f._aData = cr(n, f, u, u === r ? r : f._aData).data;
        if (f._aSortData = null, f._aFilterData = null, e = n.aoColumns, u !== r) e[u].sType = null;
        else {
            for (i = 0, s = e.length; i < s; i++) e[i].sType = null;
            ar(n, f)
        }
    }
    ...
    function cr(t, i, u, f) {
        var s = [],
            ...
            a = function(n, t) {
                if ("string" == typeof n) {
                    var i = n.indexOf("@"); - 1 !== i && (i = n.substring(i + 1), et(n)(f, t.getAttribute(i)))
                }
            },
            y = function(t) {
                (u === r || u === c) && (o = p[c], l = n.trim(t.innerHTML), o && o._bAttrSrc ? (et(o.mData._)(f, l), a(o.mData.sort, t), a(o.mData.type, t), a(o.mData.filter, t)) : v ? (o._setter || (o._setter = et(o.mData)), o._setter(f, l)) : f[c] = l);
                c++
            };
        if (e)
            for (; e;) h = e.nodeName.toUpperCase(), ("TD" == h || "TH" == h) && (y(e), s.push(e)), e = e.nextSibling;
        else
            for (s = i.anCells, e = 0, h = s.length; e < h; e++) y(s[e]);
    ...
    function lr(n, t, r, u) {
        var h = n.aoData[t],
            ...
            c, s, f, e, v;
        if (null === h.nTr) {
            for (c = r || i.createElement("tr"), h.nTr = c, h.anCells = a, c._DT_RowIndex = t, ar(n, h), e = 0, v = n.aoColumns.length; e < v; e++) f = n.aoColumns[e], s = r ? u[e] : i.createElement(f.sCellType), s._DT_CellIndex = {
                row: t,
                column: e
            }, a.push(s), (!r || f.mRender || f.mData !== e) && (s.innerHTML = y(n, t, e, "display")), f.sClass && (s.className += " " + f.sClass), f.bVisible && !r ? c.appendChild(s) : !f.bVisible && r && s.parentNode.removeChild(s), f.fnCreatedCell && f.fnCreatedCell.call(n.oInstance, s, y(n, t, e), l, t, e);
    ...
    function ar(t, i) {
        var f = i.nTr,
            r = i._aData,
            u;
        f && (u = t.rowIdFn(r), u && (f.id = u), r.DT_RowClass && (u = r.DT_RowClass.split(" "), i.__rowc = i.__rowc ? nr(i.__rowc.concat(u)) : u, n(f).removeClass(i.__rowc.join(" ")).addClass(r.DT_RowClass)), r.DT_RowAttr && n(f).attr(r.DT_RowAttr), r.DT_RowData && n(f).data(r.DT_RowData))
    }

    function bu(t) {
        var r, e, u, c, i, f = t.nTHead,
            l = t.nTFoot,
            o = 0 === n("th, td", f).length,
            s = t.oClasses,
            h = t.aoColumns;
        for (o && (c = n("<tr/>").appendTo(f)), r = 0, e = h.length; r < e; r++) i = h[r], u = n(i.nTh).addClass(i.sClass), o && u.appendTo(c), t.oFeatures.bSort && (u.addClass(i.sSortingClass), !1 !== i.bSortable && (u.attr("tabindex", t.iTabIndex).attr("aria-controls", t.sTableId), kr(t, i.nTh, r))), i.sTitle != u[0].innerHTML && u.html(i.sTitle), nu(t, "header")(t, u, i, s);
        if (o && dt(t.aoHeader, f), n(f).find(">tr").attr("role", "row"), n(f).find(">tr>th, >tr>td").addClass(s.sHeaderTH), n(l).find(">tr>th, >tr>td").addClass(s.sFooterTH), null !== l)
            for (t = t.aoFooter[0], r = 0, e = t.length; r < e; r++) i = h[r], i.nTf = t[r].cell, i.sClass && n(i.nTf).addClass(i.sClass)
    }
    ...
    function kt(t, i, u) {
        var f, l, e, o = [],
            ...
            h;
        if (i) {
            for (u === r && (u = !1), f = 0, l = i.length; f < l; f++) {
                for (o[f] = i[f].slice(), o[f].nTr = i[f].nTr, e = s - 1; 0 <= e; e--) t.aoColumns[e].bVisible || u || o[f].splice(e, 1);
                c.push([])
            }
            for (f = 0, l = o.length; f < l; f++) {
                if (t = o[f].nTr)
                    for (; e = t.firstChild;) t.removeChild(e);
                for (e = 0, i = o[f].length; e < i; e++)
                    if (h = s = 1, c[f][e] === r) {
                        for (t.appendChild(o[f][e].cell), c[f][e] = 1; o[f + s] !== r && o[f][e].cell == o[f + s][e].cell;) c[f + s][e] = 1, s++;
                        for (; o[f][e + h] !== r && o[f][e].cell == o[f][e + h].cell;) {
                            for (u = 0; u < s; u++) c[f + u][e + h] = 1;
                            h++
                        }
    ...
    function ut(t) {
        var l = o(t, "aoPreDrawCallback", "preDraw", [t]),
            i, y, e, s, p;
        if (-1 !== n.inArray(!1, l)) w(t, !1);
        else {
            var l = [],
                f = 0,
                h = t.asStripeClasses,
                ...
                u = "ssp" == v(t),
                a = t.aiDisplay;
            if (t.bDrawing = !0, i !== r && -1 !== i && (t._iDisplayStart = u ? i : i >= t.fnRecordsDisplay() ? 0 : i, t.iInitDisplayStart = -1), i = t._iDisplayStart, y = t.fnDisplayEnd(), t.bDeferLoading) t.bDeferLoading = !1, t.iDraw++, w(t, !1);
            else if (u) {
                if (!t.bDestroying && !du(t)) return
            } else t.iDraw++;
            if (0 !== a.length)
                for (c = u ? t.aoData.length : y, u = u ? 0 : i; u < c; u++) e = a[u], s = t.aoData[e], null === s.nTr && lr(t, e), e = s.nTr, 0 !== b && (p = h[f % b], s._sRowStripe != p && (n(e).removeClass(s._sRowStripe).addClass(p), s._sRowStripe = p)), o(t, "aoRowCallback", null, [e, s._aData, f, u]), l.push(e), f++;
            else f = c.sZeroRecords, 1 == t.iDraw && "ajax" == v(t) ? f = c.sLoadingRecords : c.sEmptyTable && 0 === t.fnRecordsTotal() && (f = c.sEmptyTable), l[0] = n("<tr/>", {
                "class": b ? h[0] : ""
            }).append(n("<td />", {
                valign: "top",
                colSpan: pt(t),
    ...
    function ku(t) {
        var v = t.oClasses,
            ...
            a, e, r, i, o, f, s, h;
        for (t.nHolding = y[0], t.nTableWrapper = c[0], t.nTableReinsertBefore = t.nTable.nextSibling, a = t.sDom.split(""), h = 0; h < a.length; h++) {
            if (e = null, r = a[h], "<" == r) {
                if (i = n("<div/>")[0], o = a[h + 1], "'" == o || '"' == o) {
                    for (f = "", s = 2; a[h + s] != o;) f += a[h + s], s++;
                    "H" == f ? f = v.sJUIHeader : "F" == f && (f = v.sJUIFooter); - 1 != f.indexOf(".") ? (o = f.split("."), i.id = o[0].substr(1, o[0].length - 1), i.className = o[1]) : "#" == f.charAt(0) ? i.id = f.substr(1, f.length - 1) : i.className = f;
                    h += s
                }
                c.append(i);
                c = n(i)
            } else if (">" == r) c = c.parent();
            else if ("l" == r && l.bPaginate && l.bLengthChange) e = af(t);
            else if ("f" == r && l.bFilter) e = tf(t);
            else if ("r" == r && l.bProcessing) e = yf(t);
            else if ("t" == r) e = pf(t);
            else if ("i" == r && l.bInfo) e = hf(t);
            else if ("p" == r && l.bPaginate) e = vf(t);
            else if (0 !== u.ext.feature.length)
                for (i = u.ext.feature, s = 0, o = i.length; s < o; s++)
                    if (r == i[s].cFeature) {
                        e = i[s].fnInit(t);
                        break
                    } e && (i = t.aanFeatures, i[r] || (i[r] = []), i[r].push(e), c.append(e))
        }
        y.replaceWith(c);
        t.nHolding = null
    }
    ...
    function dt(t, i) {
        ...
        for (r = 0, h = c.length; r < h; r++)
            for (l = c[r], u = l.firstChild; u;) {
                if ("TD" == u.nodeName.toUpperCase() || "TH" == u.nodeName.toUpperCase()) {
                    for (e = 1 * u.getAttribute("colspan"), o = 1 * u.getAttribute("rowspan"), e = !e || 0 === e || 1 === e ? 1 : e, o = !o || 0 === o || 1 === o ? 1 : o, f = 0, s = t[r]; s[f];) f++;
                    for (a = f, v = 1 === e ? !0 : !1, s = 0; s < e; s++)
                        for (f = 0; f < o; f++) t[r + f][a + s] = {
                            cell: u,
                            unique: v
                        }, t[r + f].nTr = l
                }
    ...
    function ci(n, t, i) {
        var u = [],
            t, f, r, e;
        for (i || (i = n.aoHeader, t && (i = [], dt(i, t))), t = 0, f = i.length; t < f; t++)
    ...
    function li(t, i, r) {
        ...
        i && n.isArray(i) && (e = {}, c = /(.*?)\[\]$/, n.each(i, function(n, t) {
            var i = t.name.match(c);
            i ? (i = i[0], e[i] || (e[i] = []), e[i].push(t.value)) : e[t.name] = t.value
        }), i = e);
        var s, u = t.ajax,
            l = t.oInstance,
            h = function(n) {
        ...
        n.isPlainObject(u) && u.data && (s = u.data, f = n.isFunction(s) ? s(i, t) : s, i = n.isFunction(s) && f ? f : n.extend(!0, i, f), delete u.data);
        f = {
            data: i,
            success: function(n) {
            ...
            error: function(i, r) {
                var u = o(t, null, "xhr", [t, null, t.jqXHR]); - 1 === n.inArray(!0, u) && ("parsererror" == r ? tt(t, 0, "Invalid JSON response", 1) : 4 === i.readyState && tt(t, 0, "Ajax error", 7));
                w(t, !1)
            }
        };
        t.oAjaxData = i;
        ...
        t.fnServerData ? t.fnServerData.call(l, t.sAjaxSource, n.map(i, function(n, t) {
            ...
            url: u || t.sAjaxSource
        })) : n.isFunction(u) ? t.jqXHR = u.call(l, i, h, t) : (t.jqXHR = n.ajax(n.extend(f, u)), u.data = s)
    }

    function du(n) {
        return n.bAjaxDataGet ? (n.iDraw++, w(n, !0), li(n, gu(n), function(t) {
            nf(n, t)
        }), !1) : !0
    }
    ...
    function gu(t) {
        var e = t.aoColumns,
            ...
            o, f, h, y = ht(t),
            i, c;
        for (r = t._iDisplayStart, o = !1 !== s.bPaginate ? t._iDisplayLength : -1, i = function(n, t) {
                a.push({
                    name: n,
                    value: t
                })
            }, i("sEcho", t.iDraw), i("iColumns", v), i("sColumns", b(e, "sName").join(",")), i("iDisplayStart", r), i("iDisplayLength", o), c = {
                draw: t.iDraw,
                columns: [],
                order: [],
                start: r,
            ...
            }, r = 0; r < v; r++) f = e[r], h = p[r], o = "function" == typeof f.mData ? "function" : f.mData, c.columns.push({
            data: o,
            name: f.sName,
        ...
        }), i("mDataProp_" + r, o), s.bFilter && (i("sSearch_" + r, h.sSearch), i("bRegex_" + r, h.bRegex), i("bSearchable_" + r, f.bSearchable)), s.bSort && i("bSortable_" + r, f.bSortable);
        return s.bFilter && (i("sSearch", l.sSearch), i("bRegex", l.bRegex)), s.bSort && (n.each(y, function(n, t) {
            c.order.push({
                column: t.col,
                dir: t.dir
            });
            i("iSortCol_" + n, t.col);
            i("sSortDir_" + n, t.dir)
        }), i("iSortingCols", y.length)), e = u.ext.legacy.ajax, null === e ? t.sAjaxSource ? a : c : e ? a : c
    }
    ...
    function nf(n, t) {
        ...
        if (i) {
            if (1 * i < n.iDraw) return;
            n.iDraw = 1 * i
        }
        for (si(n), n._iRecordsTotal = parseInt(u, 10), n._iRecordsDisplay = parseInt(e, 10), i = 0, u = f.length; i < u; i++) rt(n, f[i]);
    ...
    function gt(n, t, i) {
        ...
        if (or(n), "ssp" != v(n)) {
            for (ff(n, t.sSearch, i, t.bEscapeRegex !== r ? !t.bEscapeRegex : t.bRegex, t.bSmart, t.bCaseInsensitive), e(t), t = 0; t < u.length; t++) uf(n, u[t].sSearch, t, u[t].bEscapeRegex !== r ? !u[t].bEscapeRegex : u[t].bRegex, u[t].bSmart, u[t].bCaseInsensitive);
            rf(n)
        } else e(t);
        n.bFiltered = !0;
        o(n, null, "search", [n])
    ...
    function rf(t) {
        for (var s = u.ext.search, i = t.aiDisplay, e, r, o = 0, c = s.length; o < c; o++) {
            for (var h = [], f = 0, l = i.length; f < l; f++) r = i[f], e = t.aoData[r], s[o](t, e._aFilterData, r, e._aData, f) && h.push(r);
            i.length = 0;
            n.merge(i, h)
        }
    }
    ...
    function uf(n, t, i, r, u, f) {
        if ("" !== t)
            for (var e = n.aiDisplay, r = vr(t, r, u, f), u = e.length - 1; 0 <= u; u--) t = n.aoData[e[u]]._aFilterData[i], r.test(t) || e.splice(u, 1)
    }

    function ff(n, t, i, r, f, e) {
        var r = vr(t, r, f, e),
            f = n.oPreviousSearch.sSearch,
            e = n.aiDisplayMaster,
            o;
        if (0 !== u.ext.search.length && (i = !0), o = ef(n), 0 >= t.length) n.aiDisplay = e.slice();
        else
            for ((o || i || f.length > t.length || 0 !== t.indexOf(f) || n.bSorted) && (n.aiDisplay = e.slice()), t = n.aiDisplay, i = t.length - 1; 0 <= i; i--) r.test(n.aoData[t[i]]._sFilterRow) || t.splice(i, 1)
    }

    function vr(t, i, r, u) {
        return t = i ? t : vi(t), r && (t = "^(?=.*?" + n.map(t.match(/"[^"]+"|[^ ]+/g) || [""], function(n) {
            if ('"' === n.charAt(0)) var t = n.match(/^"(.*)"$/),
                n = t ? t[1] : n;
            return n.replace('"', "")
        }).join(")(?=.*?") + ").*$"), RegExp(t, u ? "i" : "")
    }
    ...
    function ef(n) {
        var s = n.aoColumns,
            i, r, f, h, c, e, t, o, l = u.ext.type.search;
        for (i = !1, r = 0, h = n.aoData.length; r < h; r++)
            if (o = n.aoData[r], !o._aFilterData) {
                for (e = [], f = 0, c = s.length; f < c; f++) i = s[f], i.bSearchable ? (t = y(n, r, f, "filter"), l[i.sType] && (t = l[i.sType](t)), null === t && (t = ""), "string" != typeof t && t.toString && (t = t.toString())) : t = "", t.indexOf && -1 !== t.indexOf("&") && (tr.innerHTML = t, t = we ? tr.textContent : tr.innerText), t.replace && (t = t.replace(/[\r\n]/g, "")), e.push(t);
                o._aFilterData = e;
    ...
    function ni(n) {
        var t, r, e = n.iInitDisplayStart,
            i = n.aoColumns,
            u, f;
        if (r = n.oFeatures, f = n.bDeferLoading, n.bInitialised) {
            for (ku(n), bu(n), kt(n, n.aoHeader), kt(n, n.aoFooter), w(n, !0), r.bAutoWidth && wr(n), t = 0, r = i.length; t < r; t++) u = i[t], u.sWidth && (u.nTh.style.width = h(u.sWidth));
            o(n, null, "preInit", [n]);
            ot(n);
            i = v(n);
            ("ssp" != i || f) && ("ajax" == i ? li(n, [], function(i) {
                var r = ai(n, i);
                for (t = 0; t < r.length; t++) rt(n, r[t]);
    ...
    function af(t) {
        for (var r, o = t.oClasses, e = t.sTableId, i = t.aLengthMenu, u = n.isArray(i[0]), s = u ? i[0] : i, i = u ? i[1] : i, u = n("<select/>", {
            ...
            }), f = 0, h = s.length; f < h; f++) u[0][f] = new Option(i[f], s[f]);
        return r = n("<div><label/><\/div>").addClass(o.sLength), t.aanFeatures.l || (r[0].id = e + "_length"), r.children().append(t.oLanguage.sLengthMenu.replace("_MENU_", u[0].outerHTML)), n("select", r).val(t._iDisplayLength).bind("change.DT", function() {
            yr(t, n(this).val());
            ut(t)
    ...
    function vf(t) {
        var i = t.sPaginationType,
            ...
            f = t.aanFeatures;
        return e || r.fnInit(t, i, o), f.p || (i.id = t.sTableId + "_paginate", t.aoDrawCallback.push({
            fn: function(n) {
                if (e)
                    for (var u = n._iDisplayStart, i = n._iDisplayLength, s = n.fnRecordsDisplay(), t = -1 === i, u = t ? 0 : Math.ceil(u / i), i = t ? 1 : Math.ceil(s / i), s = r(u, i), t = 0, h = f.p.length; t < h; t++) nu(n, "pageButton")(n, f.p[t], t, s, u, i);
                else r.fnUpdate(n, o)
            },
            sName: "pagination"
        })), i
    ...
    function pr(n, t, i) {
        var r = n._iDisplayStart,
            u = n._iDisplayLength,
            f = n.fnRecordsDisplay();
        return 0 === f || -1 === u ? r = 0 : "number" == typeof t ? (r = t * u, r > f && (r = 0)) : "first" == t ? r = 0 : "previous" == t ? (r = 0 <= u ? r - u : 0, 0 > r && (r = 0)) : "next" == t ? r + u < f && (r += u) : "last" == t ? r = Math.floor((f - 1) / u) * u : tt(n, 0, "Unknown paging action: " + t, 5), t = n._iDisplayStart !== r, n._iDisplayStart = r, t && (o(n, null, "page", [n]), i && ut(n)), t
    }
    ...
    function pf(t) {
        var i = n(t.nTable),
            f;
        if (i.attr("role", "grid"), f = t.oScroll, "" === f.sX && "" === f.sY) return t.nTable;
        var u = f.sX,
            c = f.sY,
            r = t.oClasses,
        ...
        var i = e.children(),
            ...
            r = i[1],
            v = o ? i[2] : null;
        if (u) n(r).on("scroll.DT", function() {
            var n = this.scrollLeft;
            a.scrollLeft = n;
            o && (v.scrollLeft = n)
        });
        return n(r).css(c && f.bCollapse ? "max-height" : "height", c), t.nScrollHead = a, t.nScrollBody = r, t.nScrollFoot = v, t.aoDrawCallback.push({
            fn: ti,
            sName: "scrolling"
        }), e[0]
    }
    ...
    function ti(t) {
        var f = t.oScroll,
            ...
            y = n(i),
            d = i.style,
            nt = n(t.nScrollFoot).children("div"),
            pt = nt.children("table"),
            w = n(t.nTHead),
            u = n(t.nTable),
            et = u[0],
            b = et.style,
            c = t.nTFoot ? n(t.nTFoot) : null,
            ot = t.oBrowser,
            it = ot.bScrollOversize,
            l, o, a, k, rt = [],
            ut = [],
            ht = [],
            ct, lt = function(n) {
        ...
        t.scrollBarVis !== o && t.scrollBarVis !== r ? (t.scrollBarVis = o, st(t)) : (t.scrollBarVis = o, u.children("thead, tfoot").remove(), k = w.clone().prependTo(u), w = w.find("tr"), o = k.find("tr"), k.find("th, td").removeAttr("tabindex"), c && (a = c.clone().prependTo(u), l = c.find("tr"), a = a.find("tr")), s || (d.width = "100%", e[0].style.width = "100%"), n.each(ci(t, k), function(n, i) {
            ct = vt(t, n);
            i.style.width = t.aoColumns[ct].sWidth
        }), c && g(function(n) {
            n.style.width = ""
        }, a), e = u.outerWidth(), "" === s ? (b.width = "100%", it && (u.find("tbody").height() > i.offsetHeight || "scroll" == y.css("overflow-y")) && (b.width = h(u.outerWidth() - f)), e = u.outerWidth()) : "" !== v && (b.width = h(v), e = u.outerWidth()), g(lt, o), g(function(t) {
            ht.push(t.innerHTML);
            rt.push(h(n(t).css("width")))
        }, o), g(function(n, t) {
            n.style.width = rt[t]
        }, w), n(o).height(0), c && (g(lt, a), g(function(t) {
            ut.push(h(n(t).css("width")))
        }, a), g(function(n, t) {
            n.style.width = ut[t]
        }, l), n(a).height(0)), g(function(n, t) {
            n.innerHTML = '<div class="dataTables_sizing" style="height:0;overflow:hidden;">' + ht[t] + "<\/div>";
            n.style.width = rt[t]
        }, o), c && g(function(n, t) {
            n.innerHTML = "";
            n.style.width = ut[t]
        }, a), u.outerWidth() < e ? (l = i.scrollHeight > i.offsetHeight || "scroll" == y.css("overflow-y") ? e + f : e, it && (i.scrollHeight > i.offsetHeight || "scroll" == y.css("overflow-y")) && (b.width = h(l - f)), ("" === s || "" !== v) && tt(t, 1, "Possible column misalignment", 6)) : l = "100%", d.width = h(l), at.width = h(l), c && (t.nScrollFoot.style.width = h(l)), !p && it && (d.height = h(et.offsetHeight + f)), s = u.outerWidth(), yt[0].style.width = h(s), ft.width = h(s), v = u.height() > i.clientHeight || "scroll" == y.css("overflow-y"), p = "padding" + (ot.bScrollbarLeft ? "Left" : "Right"), ft[p] = v ? f + "px" : "0px", c && (pt[0].style.width = h(s), nt[0].style.width = h(s), nt[0].style[p] = v ? f + "px" : "0px"), y.scroll(), (t.bSorted || t.bFiltered) && !t._drawHold && (i.scrollTop = 0))
    }
    ...
    function wr(i) {
        var s = i.nTable,
            ...
            v = k.bScrollOversize,
            d;
        for ((r = s.style.width) && -1 !== r.indexOf("%") && (l = r), r = 0; r < o.length; r++) f = a[o[r]], null !== f.sWidth && (f.sWidth = wf(f.sWidthOrig, e), w = !0);
        if (!v && (w || p || y || u != pt(i) || u != c.length)) {
            for (u = n(s).clone().css("visibility", "hidden").removeAttr("id"), u.find("tbody tr").remove(), d = n("<tr/>").appendTo(u.find("tbody")), u.find("thead, tfoot").remove(), u.append(n(i.nTHead).clone()).append(n(i.nTFoot).clone()), u.find("tfoot th, tfoot td").css("width", ""), c = ci(i, u.find("thead")[0]), r = 0; r < o.length; r++) f = a[o[r]], c[r].style.width = null !== f.sWidthOrig && "" !== f.sWidthOrig ? h(f.sWidthOrig) : "", f.sWidthOrig && p && n(c[r]).append(n("<div/>").css({
                width: f.sWidthOrig,
                margin: 0,
                padding: 0,
                border: 0,
            ...
            if (i.aoData.length)
                for (r = 0; r < o.length; r++) w = o[r], f = a[w], n(bf(i, w)).clone(!1).append(f.sContentPadding).appendTo(d);
            for (f = n("<div/>").css(p || y ? {
                    position: "absolute",
                    top: 0,
                    left: 0,
                    ...
                    right: 0,
                    overflow: "hidden"
                } : {}).append(u).appendTo(e), p && b ? u.width(b) : p ? (u.css("width", "auto"), u.removeAttr("width"), u.width() < e.clientWidth && l && u.width(e.clientWidth)) : y ? u.width(e.clientWidth) : l && u.width(l), r = y = 0; r < o.length; r++) e = n(c[r]), b = e.outerWidth() - e.width(), e = k.bBounding ? Math.ceil(c[r].getBoundingClientRect().width) : e.outerWidth(), y += e, a[o[r]].sWidth = h(e - b);
            s.style.width = h(y);
            f.remove()
        } else
            for (r = 0; r < u; r++) o = vt(i, r), null !== o && (a[o].sWidth = h(c.eq(r).width()));
        l && (s.style.width = h(l));
        (l || p) && !i._reszEvt && (s = function() {
            n(t).bind("resize.DT-" + i.sInstance, pi(function() {
                st(i)
            }))
        }, v ? setTimeout(s, 1e3) : s(), i._reszEvt = !0)
    }
    ...
    function bf(t, i) {
        var r = kf(t, i),
            u;
        return 0 > r ? null : (u = t.aoData[r], u.nTr ? u.anCells[i] : n("<td/>").html(y(t, r, i, "display"))[0])
    }

    function kf(n, t) {
        for (var i, u = -1, f = -1, r = 0, e = n.aoData.length; r < e; r++) i = y(n, r, t, "display") + "", i = i.replace(be, ""), i = i.replace(/&nbsp;/g, " "), i.length > u && (u = i.length, f = r);
        return f
    }
    ...
    function ht(t) {
        var i, o, a = [],
            h = t.aoColumns,
            e, s, c, l, f;
        for (i = t.aaSortingFixed, o = n.isPlainObject(i), f = [], e = function(t) {
                t.length && !n.isArray(t[0]) ? f.push(t) : n.merge(f, t)
            }, n.isArray(i) && e(i), o && i.pre && e(i.pre), e(t.aaSorting), o && i.post && e(i.post), t = 0; t < f.length; t++)
            for (l = f[t][0], e = h[l].aDataSort, i = 0, o = e.length; i < o; i++) s = e[i], c = h[s].sType || "string", f[t]._idx === r && (f[t]._idx = n.inArray(f[t][1], h[s].asSorting)), a.push({
                src: l,
                col: s,
                dir: f[t][1],
                index: f[t]._idx,
    ...
    function df(n) {
        var t, f, r = [],
            ...
            e = n.aoData,
            c = 0,
            s, o = n.aiDisplayMaster,
            i;
        for (or(n), i = ht(n), t = 0, f = i.length; t < f; t++) s = i[t], s.formatter && c++, ne(n, s.col);
        if ("ssp" != v(n) && 0 !== i.length) {
            for (t = 0, f = o.length; t < f; t++) r[o[t]] = t;
            c === i.length ? o.sort(function(n, t) {
                for (var u, f, s, h = i.length, c = e[n]._aSortData, l = e[t]._aSortData, o = 0; o < h; o++)
                    if (s = i[o], u = c[s.col], f = l[s.col], u = u < f ? -1 : u > f ? 1 : 0, 0 !== u) return "asc" === s.dir ? u : -u;
                return u = r[n], f = r[t], u < f ? -1 : u > f ? 1 : 0
            }) : o.sort(function(n, t) {
                for (var u, o, f, c = i.length, l = e[n]._aSortData, a = e[t]._aSortData, s = 0; s < c; s++)
                    if (f = i[s], u = l[f.col], o = a[f.col], f = h[f.type + "-" + f.dir] || h["string-" + f.dir], u = f(u, o), 0 !== u) return u;
                return u = r[n], o = r[t], u < o ? -1 : u > o ? 1 : 0
            })
        }
        n.bSorted = !0
    }
    ...
    function gf(n) {
        for (var u, f, e, t, o = n.aoColumns, i = ht(n), n = n.oLanguage.oAria, r = 0, s = o.length; r < s; r++) t = o[r], u = t.asSorting, e = t.sTitle.replace(/<.*?>/g, ""), f = t.nTh, f.removeAttribute("aria-sort"), t.bSortable && (0 < i.length && i[0].col == r ? (f.setAttribute("aria-sort", "asc" == i[0].dir ? "ascending" : "descending"), t = u[i[0].index + 1] || u[0]) : t = u[0], e += "asc" === t ? n.sSortAscending : n.sSortDescending), f.setAttribute("aria-label", e)
    }
    ...
    function br(t, i, u, f) {
        var e = t.aaSorting,
            ...
            s = function(t, i) {
                var u = t._idx;
                return u === r && (u = n.inArray(t[1], o)), u + 1 < o.length ? u + 1 : i ? null : 0
            };
        "number" == typeof e[0] && (e = t.aaSorting = [e]);
        u && t.oFeatures.bSortMulti ? (u = n.inArray(i, b(e, "0")), -1 !== u ? (i = s(e[u], !0), null === i && 1 === e.length && (i = 0), null === i ? e.splice(u, 1) : (e[u][1] = o[i], e[u]._idx = i)) : (e.push([i, o[0], 0]), e[e.length - 1]._idx = 0)) : e.length && e[0][0] == i ? (i = s(e[0]), e.length = 1, e[0][1] = o[i], e[0]._idx = i) : (e.length = 0, e.push([i, o[0]]), e[0]._idx = 0);
        ot(t);
    ...
    function kr(n, t, i, r) {
        var u = n.aoColumns[i];
        dr(t, {}, function(t) {
            !1 !== u.bSortable && (n.oFeatures.bProcessing ? (w(n, !0), setTimeout(function() {
                br(n, i, t.shiftKey, r);
                "ssp" !== v(n) && w(n, !1)
    ...
    function wi(t) {
        ...
        if (i.bSort && i.bSortClasses) {
            for (i = 0, r = e.length; i < r; i++) u = e[i].src, n(b(t.aoData, "anCells", u)).removeClass(o + (2 > i ? i + 1 : 3));
            for (i = 0, r = f.length; i < r; i++) u = f[i].src, n(b(t.aoData, "anCells", u)).addClass(o + (2 > i ? i + 1 : 3))
        }
        t.aLastSort = f
    }
    ...
    function ne(n, t) {
        var i = n.aoColumns[t],
            f = u.ext.order[i.sSortDataType],
            o;
        f && (o = f.call(n.oInstance, n, t, yt(n, t)));
        for (var e, s = u.ext.type.order[i.sType + "-pre"], r = 0, h = n.aoData.length; r < h; r++)(i = n.aoData[r], i._aSortData || (i._aSortData = []), !i._aSortData[t] || f) && (e = f ? o[r] : y(n, r, t, "sort"), i._aSortData[t] = s ? s(e) : e)
    }
    ...
    function te(t) {
        var u, s, e = t.aoColumns,
            i, f;
        if (t.oFeatures.bStateSave && (i = t.fnStateLoadCallback.call(t.oInstance, t), i && i.time && (u = o(t, "aoStateLoadParams", "stateLoadParams", [t, i]), -1 === n.inArray(!1, u) && (u = t.iStateDuration, !(0 < u && i.time < +new Date - 1e3 * u) && e.length === i.columns.length)))) {
            for (t.oLoadedState = n.extend(!0, {}, i), i.start !== r && (t._iDisplayStart = i.start, t.iInitDisplayStart = i.start), i.length !== r && (t._iDisplayLength = i.length), i.order !== r && (t.aaSorting = [], n.each(i.order, function(n, i) {
                    t.aaSorting.push(i[0] >= e.length ? [0, i[1]] : i)
                })), i.search !== r && n.extend(t.oPreviousSearch, sf(i.search)), u = 0, s = i.columns.length; u < s; u++) f = i.columns[u], f.visible !== r && (e[u].bVisible = f.visible), f.search !== r && n.extend(t.aoPreSearchCols[u], sf(f.search));
    ...
    function tt(n, i, r, f) {
        ...
        else if (i = u.ext, i = i.sErrMode || i.errMode, n && o(n, null, "error", [n, f, r]), "alert" == i) alert(r);
        else {
            if ("throw" == i) throw Error(r);
    ...
    function k(t, i, u, f) {
        ...
        }) : (f === r && (f = u), i[u] !== r && (t[f] = i[u]))
    }

    function ie(t, i, r) {
        var f, u;
        for (u in i) i.hasOwnProperty(u) && (f = i[u], n.isPlainObject(f) ? (n.isPlainObject(t[u]) || (t[u] = {}), n.extend(!0, t[u], f)) : t[u] = r && "data" !== u && "aaData" !== u && n.isArray(f) ? f.slice() : f);
        return t
    }
    ...
    function dr(t, i, r) {
        n(t).bind("click.DT", i, function(n) {
            ...
            13 === n.which && (n.preventDefault(), r(n))
    ...
    function o(t, i, r, u) {
        ...
        })), null !== r && (i = n.Event(r + ".dt"), n(t.nTable).trigger(i, u), f.push(i.result)), f
    }
    ...
    function di(n, t) {
        var i = [],
            i = cu.numbers_length,
            r = Math.floor(i / 2);
        return t <= i ? i = ct(0, t) : n <= r ? (i = ct(0, i - 2), i.push("ellipsis"), i.push(t - 1)) : (n >= t - 1 - r ? i = ct(t - (i - 2), t) : (i = ct(n - r + 2, n + r - 1), i.push("ellipsis"), i.push(t - 1)), i.splice(0, 0, "ellipsis"), i.splice(0, 0, 0)), i.DT_el = "span", i
    }
    ...
    var u, c, e, f, s, tu = {},
        ...
        oe = function(n, t) {
            return tu[t] || (tu[t] = RegExp(vi(t), "g")), "string" == typeof n && "." !== t ? n.replace(/\./g, "").replace(tu[t], ".") : n
        },
        ru = function(n, t, i) {
            var r = "string" == typeof n;
            return it(n) ? !0 : (t && r && (n = oe(n, t)), i && r && (n = n.replace(iu, "")), !isNaN(parseFloat(n)) && isFinite(n))
        },
        se = function(n, t, i) {
    ...
    u = function(t) {
        ...
        this.fnDeleteRow = function(n, t, i) {
            var u = this.api(!0),
                ...
                f = n.settings()[0],
                e = f.aoData[n[0][0]];
            return n.remove(), t && t.call(this, f, e), (i === r || i) && u.draw(), e
        };
        ...
        this.fnGetData = function(n, t) {
            var i = this.api(!0),
                u;
            return n !== r ? (u = n.nodeName ? n.nodeName.toLowerCase() : "", t !== r || "td" == u || "th" == u ? i.cell(n, t).data() : i.row(n).data() || null) : i.data().toArray()
        };
        ...
        this.fnGetPosition = function(n) {
            ...
            return "TR" == t ? i.row(n).index() : "TD" == t || "TH" == t ? (n = i.cell(n).index(), [n.row, n.columnVisible, n.column]) : null
        };
        ...
        this.fnUpdate = function(n, t, i, u, f) {
            var e = this.api(!0);
            return i === r || null === i ? e.row(t).data(n) : e.cell(t, i).data(n), (f === r || f) && e.columns.adjust(), (u === r || u) && e.draw(), 0
        };
        ...
        for (f in u.ext.internal) f && (this[f] = ue(f));
        return this.each(function() {
            var e = {},
                e = 1 < h ? ie(e, t, !0) : t,
                c = 0,
                l, b = this.getAttribute("id"),
                ot = !1,
                p = u.defaults,
                d = n(this),
                w, y, f, g, ut, it, et;
            if ("table" != this.nodeName.toLowerCase()) tt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
            else {
                for (lu(p), au(p.column), nt(p, p, !0), nt(p.column, p.column, !0), nt(p, n.extend(e, d.data())), w = u.settings, c = 0, l = w.length; c < l; c++) {
                    if (y = w[c], y.nTable == this || y.nTHead.parentNode == this || y.nTFoot && y.nTFoot.parentNode == this) {
                        if (c = e.bRetrieve !== r ? e.bRetrieve : p.bRetrieve, s || c) return y.oInstance;
                ...
                if ((null === b || "" === b) && (this.id = b = "DataTables_Table_" + u.ext._unique++), f = n.extend(!0, {}, u.models.oSettings, {
                    ...
                    }), ot = !0), null === e.asStripeClasses && (f.asStripeClasses = [b.sStripeOdd, b.sStripeEven]), c = f.asStripeClasses, ut = d.children("tbody").find("tr").eq(0), -1 !== n.inArray(!0, n.map(c, function(n) {
                        return ut.hasClass(n)
                    })) && (n("tbody tr", this).removeClass(c.join(" ")), f.asDestroyStripes = c.slice()), w = [], c = this.getElementsByTagName("thead"), 0 !== c.length && (dt(f.aoHeader, c[0]), w = ci(f)), null === e.aoColumns)
                    for (y = [], c = 0, l = w.length; c < l; c++) y.push(null);
                else y = e.aoColumns;
                for (c = 0, l = y.length; c < l; c++) er(f, w ? w[c] : null);
                if (pu(f, e.aoColumnDefs, y, function(n, t) {
                        ...
                        var e = f.aoColumns[n],
                            i, u;
                        e.mData === n && (i = it(t, "sort") || it(t, "order"), u = it(t, "filter") || it(t, "search"), (i !== null || u !== null) && (e.mData = {
                            _: n + ".display",
                            sort: i !== null ? n + ".@data-" + i : r,
                            type: i !== null ? n + ".@data-" + i : r,
                            filter: u !== null ? n + ".@data-" + u : r
                        }, ei(f, n)))
                    })), et = f.oFeatures, e.bStateSave && (et.bStateSave = !0, te(f, e), a(f, "aoDrawCallback", bi, "state_save")), e.aaSorting === r)
                    for (w = f.aaSorting, c = 0, l = w.length; c < l; c++) w[c][1] = f.aoColumns[c].asSorting[0];
                if (wi(f), et.bSort && a(f, "aoDrawCallback", function() {
                        if (f.bSorted) {
                            var t = ht(f),
                                i = {};
                    ...
                    }, "sc"), c = d.children("caption").each(function() {
                        this._captionSide = d.css("caption-side")
                    }), l = d.children("thead"), 0 === l.length && (l = n("<thead/>").appendTo(this)), f.nTHead = l[0], l = d.children("tbody"), 0 === l.length && (l = n("<tbody/>").appendTo(this)), f.nTBody = l[0], l = d.children("tfoot"), 0 === l.length && 0 < c.length && ("" !== f.oScroll.sX || "" !== f.oScroll.sY) && (l = n("<tfoot/>").appendTo(this)), 0 === l.length || 0 === l.children().length ? d.addClass(b.sNoFooter) : 0 < l.length && (f.nTFoot = l[0], dt(f.aoFooter, f.nTFoot)), e.aaData)
                    for (c = 0; c < e.aaData.length; c++) rt(f, e.aaData[c]);
                else(f.bDeferLoading || "dom" == v(f)) && oi(f, n(f.nTBody).children("tr"));
    ...
    var ce = [],
        ...
        ke = function(t) {
            ...
            if (t) {
                ...
                if (t.nodeName && "table" === t.nodeName.toLowerCase()) return i = n.inArray(t, e), -1 !== i ? [f[i]] : null;
            ...
            if (r) return r.map(function() {
                return i = n.inArray(this, e), -1 !== i ? f[i] : null
            }).toArray()
        };
    e = function(t, i) {
        var r, f, u, o;
    ...
    n.extend(e.prototype, {
        ...
        iterator: function(n, t, i, u) {
            var h = [],
                o, f, y, c, p, s = this.context,
                w, v, a = this.selector,
                l;
            for ("string" == typeof n && (u = i, i = t, t = n, n = !1), f = 0, y = s.length; f < y; f++)
                if (l = new e(s[f]), "table" === t) o = i.call(l, s[f], f), o !== r && h.push(o);
                else if ("columns" === t || "rows" === t) o = i.call(l, s[f], this[f], f), o !== r && h.push(o);
            else if ("column" === t || "column-rows" === t || "row" === t || "cell" === t)
                for (v = this[f], "column-rows" === t && (w = ir(s[f], a.opts)), c = 0, p = v.length; c < p; c++) o = v[c], o = "cell" === t ? i.call(l, s[f], o.row, o.column, f, c) : i.call(l, s[f], o, f, c, w), o !== r && h.push(o);
            return h.length || u ? (n = new e(s, n ? h.concat.apply([], h) : h), t = n.selector, t.rows = a.rows, t.cols = a.cols, t.opts = a.opts, n) : this
        },
    ...
    e.extend = function(t, i, r) {
        if (r.length && i && (i instanceof e || i.__dt_wrapper))
            for (var u, s = function(n, t, i) {
                ...
                }, f = 0, o = r.length; f < o; f++) u = r[f], i[u.name] = "function" == typeof u.val ? s(t, u.val, u) : n.isPlainObject(u.val) ? {} : u.val, i[u.name].__dt_wrapper = !0, e.extend(t, i[u.name], u.propExt)
    };
    e.register = f = function(t, i) {
        var u, f, r, l;
        if (n.isArray(t))
            for (u = 0, f = t.length; u < f; u++) e.register(t[u], i);
        else
    ...
    f("tables()", function(t) {
        var i, r, u, t;
        return t ? (i = e, r = this.context, "number" == typeof t ? t = [r[t]] : (u = n.map(r, function(n) {
            return n.nTable
        }), t = n(u).filter(t).map(function() {
            var t = n.inArray(this, u);
            return r[t]
        }).toArray()), i = new i(t)) : i = this, i
    });
    f("table()", function(n) {
        var n = this.tables(n),
            t = n.context;
    ...
    f("draw()", function(n) {
        return this.iterator("table", function(t) {
            "page" === n ? ut(t) : ("string" == typeof n && (n = "full-hold" === n ? !1 : !0), ot(t, !1 === n))
        })
    });
    f("page()", function(n) {
    ...
    uu = function(n, t, i) {
        ...
        "ssp" == v(n) ? ot(n, t) : (w(n, !0), r = n.jqXHR, r && 4 !== r.readyState && r.abort(), li(n, [], function(i) {
            si(n);
            for (var i = ai(n, i), r = 0, u = i.length; r < u; r++) rt(n, i[r]);
            ot(n, t);
            w(n, !1)
        }))
    };
    f("ajax.json()", function() {
        var n = this.context;
        if (0 < n.length) return n[0].json
    });
    f("ajax.params()", function() {
        var n = this.context;
        if (0 < n.length) return n[0].oAjaxData
    });
    ...
    f("ajax.url()", function(t) {
        var i = this.context;
        return t === r ? 0 === i.length ? r : (i = i[0], i.ajax ? n.isPlainObject(i.ajax) ? i.ajax.url : i.ajax : i.sAjaxSource) : this.iterator("table", function(i) {
    ...
    var fu = function(t, i, u, f, e) {
            var h = [],
                v, l, o, a, s, y;
            for (o = typeof i, i && "string" !== o && "function" !== o && i.length !== r || (i = [i]), o = 0, a = i.length; o < a; o++)
                for (l = i[o] && i[o].split ? i[o].split(",") : [i[o]], s = 0, y = l.length; s < y; s++)(v = u("string" == typeof l[s] ? n.trim(l[s]) : l[s])) && v.length && (h = h.concat(v));
            if (t = c.selector[t], t.length)
                for (o = 0, a = t.length; o < a; o++) h = t[o](f, e, h);
            return nr(h)
        },
        eu = function(t) {
        ...
        ou = function(n) {
            for (var t = 0, i = n.length; t < i; t++)
                if (0 < n[t].length) return n[0] = n[t], n[0].length = 1, n.length = 1, n.context = [n.context[t]], n;
            return n.length = 0, n
        },
        ir = function(t, i) {
            var r, u, e, o = [],
                s = t.aiDisplay,
                f;
            if (r = t.aiDisplayMaster, f = i.search, u = i.order, e = i.page, "ssp" == v(t)) return "removed" === f ? [] : ct(0, r.length);
            if ("current" == e)
                for (r = t._iDisplayStart, u = t.fnDisplayEnd(); r < u; r++) o.push(s[r]);
            else if ("current" == u || "applied" == u) o = "none" == f ? r.slice() : "applied" == f ? s.slice() : n.map(r, function(t) {
                return -1 === n.inArray(t, s) ? t : null
            });
            else if ("index" == u || "original" == u)
                for (r = 0, u = t.aoData.length; r < u; r++) "none" == f ? o.push(r) : (e = n.inArray(r, s), (-1 === e && "removed" == f || 0 <= e && "applied" == f) && o.push(r));
            return o
        };
    f("rows()", function(t, i) {
        ...
        var i = eu(i),
            u = this.iterator("table", function(u) {
                ...
                return fu("row", t, function(t) {
                    var i = ee(t),
                        e;
                    return i !== null && !f ? [i] : (e = ir(u, f), i !== null && n.inArray(i, e) !== -1) ? [i] : t ? typeof t == "function" ? n.map(e, function(n) {
                        var i = u.aoData[n];
                        return t(n, i._aData, i.nTr) ? n : null
                    }) : (i = he(ii(u.aoData, e, "nTr")), t.nodeName && n.inArray(t, i) !== -1) ? [t._DT_RowIndex] : typeof t == "string" && t.charAt(0) === "#" && (e = u.aIds[t.replace(/^#/, "")], e !== r) ? [e.idx] : n(i).filter(t).map(function() {
    ...
    s("rows().ids()", "row().id()", function(n) {
        for (var r, f, o, u = [], i = this.context, t = 0, s = i.length; t < s; t++)
            for (r = 0, f = this[t].length; r < f; r++) o = i[t].rowIdFn(i[t].aoData[this[t][r]]._aData), u.push((!0 === n ? "#" : "") + o);
        return new e(i, u)
    });
    s("rows().remove()", "row().remove()", function() {
        ...
        return this.iterator("row", function(t, i, u) {
            var o = t.aoData,
                l = o[i],
                e, h, f, c, s;
            for (o.splice(i, 1), e = 0, h = o.length; e < h; e++)
                if (f = o[e], s = f.anCells, null !== f.nTr && (f.nTr._DT_RowIndex = e), null !== s)
                    for (f = 0, c = s.length; f < c; f++) s[f]._DT_CellIndex.row = e;
    ...
    f("rows.add()", function(t) {
        var r = this.iterator("table", function(n) {
                for (var i, u = [], r = 0, f = t.length; r < f; r++) i = t[r], i.nodeName && "TR" === i.nodeName.toUpperCase() ? u.push(oi(n, i)[0]) : u.push(rt(n, i));
                return u
            }, 1),
            i = this.rows(-1);
    ...
    rr = function(n, t) {
        var i = n.context;
        i.length && (i = i[0].aoData[t !== r ? t : n[0]]) && i._details && (i._details.remove(), i._detailsShow = r, i._details = r)
    };
    su = function(n, t) {
        var o = n.context,
            i;
        if (o.length && n.length && (i = o[0].aoData[n[0]], i._details)) {
            ...
            0 < b(u, "_details").length && (r.on("draw.dt.DT_details", function(n, t) {
                ...
                if (f === t)
                    for (var i, e = pt(t), r = 0, o = u.length; r < o; r++) i = u[r], i._details && i._details.children("td[colspan]").attr("colspan", e)
            }), r.on("destroy.dt.DT_details", function(n, t) {
                if (f === t)
                    for (var i = 0, e = u.length; i < e; i++) u[i]._details && rr(r, i)
            }))
        }
    };
    f("row().child()", function(t, i) {
        var u = this.context;
        if (t === r) return u.length && this.length ? u[0].aoData[this[0]]._details : r;
            ...
            var o = u[0],
                ...
                e = function(t, i) {
                    if (n.isArray(t) || t instanceof n)
                        for (var r = 0, u = t.length; r < u; r++) e(t[r], i);
                    else t.nodeName && "tr" === t.nodeName.toLowerCase() ? f.push(t) : (r = n("<tr><td/><\/tr>").addClass(i), n("td", r).addClass(i).html(t)[0].colSpan = pt(o), f.push(r[0]))
                };
            e(t, i);
    ...
    f(["row().child.show()", "row().child().show()"], function() {
        return su(this, !0), this
    });
    f(["row().child.hide()", "row().child().hide()"], function() {
        return su(this, !1), this
    });
    ...
    hu = function(n, t, i, r, u) {
        for (var i = [], r = 0, f = u.length; r < f; r++) i.push(y(n, u[r], t));
        return i
    };
        ...
        var i = eu(i),
            u = this.iterator("table", function(r) {
                ...
                return fu("column", o, function(t) {
                    var i = ee(t),
                        c, o, h;
                    if (t === "") return ct(u.length);
                    if (i !== null) return [i >= 0 ? i : u.length + i];
                    if (typeof t == "function") return c = ir(r, e), n.map(u, function(n, i) {
                        return t(i, hu(r, i, 0, 0, c), f[i]) ? i : null
                    });
                    if (o = typeof t == "string" ? t.match(le) : "", o) switch (o[2]) {
                        case "visIdx":
                        case "visible":
                            return (i = parseInt(o[1], 10), i < 0) ? (h = n.map(u, function(n, t) {
                    ...
                    } else return n(f).filter(t).map(function() {
    ...
    s("columns().visible()", "column().visible()", function(t, i) {
        return this.iterator("column", function(u, f) {
            var v;
            if (t === r) return u.aoColumns[f].bVisible;
            var e = u.aoColumns,
                l = e[f],
                h = u.aoData,
                s, a, c;
            if (t !== r && l.bVisible !== t) {
                if (t)
                    for (v = n.inArray(!0, b(e, "bVisible"), f + 1), s = 0, a = h.length; s < a; s++) c = h[s].nTr, e = h[s].anCells, c && c.insertBefore(e[f], e[v] || null);
                else n(b(u.aoData, "anCells", f)).detach();
                l.bVisible = t;
                kt(u, u.aoHeader);
                kt(u, u.aoFooter);
                (i === r || i) && (st(u), (u.oScroll.sX || u.oScroll.sY) && ti(u));
    ...
    f("column.index()", function(n, t) {
        if (0 !== this.context.length) {
            ...
            if ("fromVisible" === n || "toData" === n) return vt(i, t);
            if ("fromData" === n || "toVisible" === n) return yt(i, t)
        }
    });
    ...
    f("cells()", function(t, i, u) {
        if (n.isPlainObject(t) && (t.row === r ? (u = t, t = null) : (u = i, i = null)), n.isPlainObject(i) && (u = i, i = null), null === i || i === r) return this.iterator("table", function(i) {
            var w = t,
                a = eu(u),
                v = i.aoData,
                c = ir(i, a),
                b = he(ii(v, c, "anCells")),
                k = n([].concat.apply([], b)),
                e, d = i.aoColumns.length,
                o, s, p, f, h, l;
            return fu("cell", w, function(t) {
                var u = typeof t == "function";
                if (t === null || t === r || u) {
                    for (o = [], s = 0, p = c.length; s < p; s++)
                        for (e = c[s], f = 0; f < d; f++) h = {
                            row: e,
                            column: f
                        }, u ? (l = v[e], t(h, y(i, e, f), l.anCells ? l.anCells[f] : null) && o.push(h)) : o.push(h);
                    return o
                }
    ...
    s("cells().cache()", "cell().cache()", function(n) {
        return n = "search" === n ? "_aFilterData" : "_aSortData", this.iterator("cell", function(t, i, r) {
    ...
    f("cell().data()", function(n) {
        var i = this.context,
            t = this[0];
        return n === r ? i.length && t.length ? y(i[0], t[0].row, t[0].column) : r : (wu(i[0], t[0].row, t[0].column, n), bt(i[0], t[0].row, "data", t[0].column), this)
    });
    f("order()", function(t, i) {
        var u = this.context;
        return t === r ? 0 !== u.length ? u[0].aaSorting : r : ("number" == typeof t ? t = [
            [t, i]
        ] : n.isArray(t[0]) || (t = Array.prototype.slice.call(arguments)), this.iterator("table", function(n) {
            n.aaSorting = t.slice()
        }))
    });
    ...
    u.versionCheck = u.fnVersionCheck = function(n) {
        for (var f = u.version.split("."), n = n.split("."), i, r, t = 0, e = n.length; t < e; t++)
            if (i = parseInt(f[t], 10) || 0, r = parseInt(n[t], 10) || 0, i !== r) return i > r;
        return !0
    };
    ...
    n.each(["on", "one", "off"], function(t, i) {
        f(i + "()", function() {
            var t = Array.prototype.slice.call(arguments),
                r;
            return t[0].match(/\.dt\b/) || (t[0] += ".dt"), r = n(this.tables().nodes()), r[i].apply(r, t), this
        })
    });
    f("clear()", function() {
        return this.iterator("table", function(n) {
    ...
    f("destroy()", function(i) {
        return i = i || !1, this.iterator("table", function(r) {
            var c = r.nTableWrapper.parentNode,
                f = r.oClasses,
                a = r.nTable,
                l = r.nTBody,
                s = r.nTHead,
            ...
            a != s.parentNode && (h.children("thead").detach(), h.append(s));
            v && a != v.parentNode && (h.children("tfoot").detach(), h.append(v));
            r.aaSorting = [];
            r.aaSortingFixed = [];
            wi(r);
            n(p).removeClass(r.asStripeClasses.join(" "));
            n("th, td", s).removeClass(f.sSortable + " " + f.sSortableAsc + " " + f.sSortableDesc + " " + f.sSortableNone);
            r.bJUI && (n("th span." + f.sSortIcon + ", td span." + f.sSortIcon, s).detach(), n("th, td", s).each(function() {
            ...
            h[s]();
            y[s]();
            !i && c && (c.insertBefore(a, r.nTableReinsertBefore), h.css("width", r.sDestroyWidth).removeClass(f.sTable), (w = r.asDestroyStripes.length) && l.children().each(function(t) {
                n(this).addClass(r.asDestroyStripes[t % w])
            }));
            c = n.inArray(r, u.settings); - 1 !== c && u.settings.splice(c, 1)
        })
    });
    ...
    f("i18n()", function(t, i, u) {
        var f = this.context[0],
            t = ft(t)(f.oLanguage);
        return t === r && (t = i), u !== r && n.isPlainObject(t) && (t = t[u] !== r ? t[u] : t._), t.replace("%d", u)
    });
    u.version = "1.10.10";
    u.settings = [];
    u.models = {};
    ...
    return n.extend(u.ext.oJUIClasses, u.ext.classes, {
                ...
                var c = t.oClasses,
                    ...
                    y = function(i, r) {
                        for (var w, f, k = function(n) {
                            ...
                            if (f = r[a], n.isArray(f)) w = n("<" + (f.DT_el || "div") + "/>").appendTo(i), y(w, f);
                            else {
                                s = null;
                                h = "";
                                switch (f) {
        ...
        if (n && !(n instanceof Date) && (!ve.test(n) || !ye.test(n))) return null;
        var t = Date.parse(n);
        ...
        return 0 !== n && (!n || "-" === n) ? -Infinity : (t && (n = oe(n, t)), n.replace && (i && (n = n.replace(i, "")), r && (n = n.replace(r, ""))), 1 * n)
    ...
    }), re(""), n.extend(!0, u.ext.renderer, {
        header: {
            _: function(t, i, r, u) {
                n(t.nTable).on("order.dt.DT", function(n, f, e, o) {
                    t === f && (n = r.idx, i.removeClass(r.sSortingClass + " " + u.sSortAsc + " " + u.sSortDesc).addClass(o[n] == "asc" ? u.sSortAsc : o[n] == "desc" ? u.sSortDesc : r.sSortingClass))
                })
            },
        ...
        number: function(n, t, i, r, u) {
            return {
                display: function(f) {
                    ...
                    var o = 0 > f ? "-" : "",
                        e = parseFloat(f);
                    return isNaN(e) ? f : (f = Math.abs(e), e = parseInt(f, 10), f = i ? t + (f - e).toFixed(i).substring(2) : "", o + (r || "") + e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, n) + f + (u || ""))
                }
            }
        },
        text: function() {
                ...
                for (var k, u, d = function(t) {
                    ...
                    if (u = r[e], n.isArray(u)) p(i, u);
                        ...
                        h && (k = n("<li>", {
                            ...
                            "data-dt-idx": y,
                            tabindex: t.iTabIndex
                        }).html(h)).appendTo(i), t.oApi._fnBindAction(k, {
                            action: u
                        }, d), y++)
                    }
            },
