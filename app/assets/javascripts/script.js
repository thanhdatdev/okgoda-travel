jQuery(document).ready(function() {
    ...
    $(document).click(function(event){
      if (searchForm.shown == true) {
        $(searchForm.class_name).click();
        updateSearchFormState('', false)
      }
    });

    let searchForm = { class_name: '', shown: false };
    function updateSearchFormState(class_name, state) {
      searchForm.class_name = class_name;
      searchForm.shown = state;
    }

    $(".dltn").click(function() {
        $(".bg-dltn").toggle(1, function() {
          if ($(this).is(':hidden')) {
                updateSearchFormState('.dltn', true);
                $(this).show();
                $(".a").addClass('bg-black ');
                ...
                updateSearchFormState('.dltn', false);
                $(this).hide();
